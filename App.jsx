...
// ══════════════════════════════════════════════════════════════════════════
// TRADUCTIONS FR / EN — dictionnaire complet de l'interface
// ══════════════════════════════════════════════════════════════════════════
const T = {
  fr: {
    // Page d'accueil
    ...
    principle_text:  "Chaque publication, projet ou activité n'est saisie qu'une seule fois. Vos réalisations sont calculées automatiquement — vous ne les remplissez jamais manuellement. Le DOI identifie chaque publication de façon unique pour éviter tout doublon.",
    ...
    load_profile:    'Retrouver mon profil existant (évite la ressaisie)',
    load_btn:        'Charger mon profil',
    ...
    rev_motif:       'Motif de la révision',
    ...
    // Dashboard
    dashboard_title: 'Mon Dashboard & CV',
    load_btn2:       'Charger',
    ...
    no_data:         'Saisissez votre email puis cliquez "Charger" pour voir votre dashboard.',
    // Projets KPIs
    ...
    admin_role:      "Sélectionnez votre niveau d'accès",
    admin_code_ph:   "Code d'accès...",
    admin_login:     'Accéder',
    admin_logout:    'Déconnexion',
    admin_reset:     '🗑 Réinitialiser toutes les données',
    ...
    gen_rapport_inst:'⬇ Générer le rapport Excel',
    gen_rapport_axe: "⬇ Rapport de l'axe",
    // Affectation
    total_affectation:'Total affectations',
    over_limit:      '⚠ Le total dépasse 100% — la soumission sera bloquée.',
    contract_duration:'Durée du contrat (calculée auto)',
    // Scores
    score_global:    'Score global',
    // Colonnes tableau
    col_nom:   'Nom', col_grade: 'Grade', col_axe: 'Axe',
    col_pub:   'Pub. acc.', col_q1: 'Q1', col_cit: 'Citations', col_score: 'Score',
    col_rapport: 'Rapport',
  },
  en: {
    ...
    principle_text:  "Each publication, project or activity is entered only once. Your achievements are calculated automatically — you never fill them in manually. The DOI uniquely identifies each publication to avoid duplicates.",
    ...
    next:            'Next →',
    identification:  'Identification',
    load_profile:    'Load my existing profile (avoids re-entry)',
    load_btn:        'Load my profile',
    ...
    dashboard_title: 'My Dashboard & CV',
    load_btn2:       'Load',
    ...
    col_statut:      'Status',
    col_indicator:   'KPI',
    no_data:         'Enter your email and click "Load" to see your dashboard.',
    ...
    admin_role:      'Select your access level',
    admin_code_ph:   'Access code...',
    admin_login:     'Access',
    admin_logout:    'Sign out',
    admin_reset:     '🗑 Reset all data',
    ...
    gen_rapport_inst:'⬇ Generate Excel report',
    gen_rapport_axe: '⬇ Axis report',
    total_affectation:'Total assignments',
    over_limit:      '⚠ Total exceeds 100% — submission will be blocked.',
    contract_duration:'Contract duration (auto-calculated)',
    score_global:    'Global score',
    col_nom: 'Name', col_grade: 'Grade', col_axe: 'Axis',
    col_pub: 'Pub. acc.', col_q1: 'Q1', col_cit: 'Citations', col_score: 'Score',
    col_rapport: 'Report',
  },
}
            ...
            <>
              ...
              <div style={{ background:'#fff', border:`0.5px solid ${C.g3}`, borderRadius:12, padding:'14px 16px', marginBottom:16 }}>
                <h4 style={{ margin:'0 0 10px', fontSize:12, fontWeight:700, color:C.navy }}>
                  💰 {lang==='fr'?'Projets de recherche — Calculés automatiquement':'Research Projects — Auto-calculated'}
                </h4>
